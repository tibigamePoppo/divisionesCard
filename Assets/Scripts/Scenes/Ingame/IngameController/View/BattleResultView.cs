    ...
    public void ShowBattleResultPanel(DivisionData player, DivisionData enemy, string winnerName,DivisionProfileType type)
    {
        ...
        switch (type)
        {
            case DivisionProfileType.surfice:
                ...
                _enemyIndexText.text = (value.IndexOf(enemy.surfaceSize) + 1).ToString() + " 位";
                _playerIndexText.text = (value.IndexOf(player.surfaceSize) + 1).ToString() + " 位";
                break;
            case DivisionProfileType.population:
                ...
                _enemyIndexText.text = (value.IndexOf(enemy.population) + 1).ToString() + " 位";
                _playerIndexText.text = (value.IndexOf(player.population) + 1).ToString() + " 位";
                break;
            case DivisionProfileType.temperature:
                ...
                _enemyIndexText.text = (value.IndexOf(enemy.temperature) + 1).ToString() + " 位";
                _playerIndexText.text = (value.IndexOf(player.temperature) + 1).ToString() + " 位";
                break;
            case DivisionProfileType.urban:
                ...
                _enemyIndexText.text = (value.IndexOf(enemy.urban) + 1).ToString() + " 位";
                _playerIndexText.text = (value.IndexOf(player.urban) + 1).ToString() + " 位";
                break;
            case DivisionProfileType.village:
                ...
                _enemyIndexText.text = (value.IndexOf(enemy.village) + 1).ToString() + " 位";
                _playerIndexText.text = (value.IndexOf(player.village) + 1).ToString() + " 位";
                break;
            case DivisionProfileType.forestSize:
                ...
                _enemyIndexText.text = value.IndexOf(enemy.forestSize).ToString() + " 位";
                _playerIndexText.text = value.IndexOf(player.forestSize).ToString() + " 位";
                break;
            case DivisionProfileType.Hospitals:
                ...
                _enemyIndexText.text = value.IndexOf(enemy.Hospitals).ToString() + " 位";
                _playerIndexText.text = value.IndexOf(player.Hospitals).ToString() + " 位";
                break;
            case DivisionProfileType.College:
                ...
                _enemyIndexText.text = value.IndexOf(enemy.College).ToString() + " 位";
                _playerIndexText.text = value.IndexOf(player.College).ToString() + " 位";
                break;
            default:
                break;
        }
